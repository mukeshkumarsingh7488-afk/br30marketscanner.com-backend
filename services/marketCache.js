const MARKET_CACHE = {
  "crypto-futures": { data: [], updatedAt: null, source: "coming-soon", status: "coming-soon", error: "", message: "Crypto Futures Coming Soon" },
  "crypto-options": { data: [], updatedAt: null, source: "coming-soon", status: "coming-soon", error: "", message: "Crypto Options Coming Soon" },
  ...
  "metal-stocks": { data: [], updatedAt: null, source: "twelvedata", status: "idle", error: "", message: "" },
